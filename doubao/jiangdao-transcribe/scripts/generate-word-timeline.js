 ...
 * Modified 2026-08-12 by 江导项目: renamed and integrated into jiangdao-transcribe.
 *
 * 从江导统一 ASR 结果生成字级别字幕
 *
 * 用法: node generate-word-timeline.js <asr_result.json> [delete_segments.json]
