...
Selected subtitle and word-timeline utilities were adapted on 2026-08-12 for
the `jiangdao-transcribe` Skill. The 2026-08-13 local version uses MLX Whisper,
changes filenames, cache handling and project integration, and keeps the
original attribution. The external Skill router is not included.
